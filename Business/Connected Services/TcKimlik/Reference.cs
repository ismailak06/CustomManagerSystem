...
namespace TcKimlik
{
    ...
    public interface KPSPublicSoap
    {
        ...
        TcKimlik.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(TcKimlik.TCKimlikNoDogrulaRequest request);
    ...
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<TcKimlik.KPSPublicSoap>, TcKimlik.KPSPublicSoap
    {
        ...
        public TcKimlik.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(TcKimlik.TCKimlikNoDogrulaRequest request)
        {
            return base.Channel.TCKimlikNoDogrula(request);
        }
        
        public System.Threading.Tasks.Task<TcKimlik.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(TcKimlik.TCKimlikNoDogrulaRequest request)
        {
