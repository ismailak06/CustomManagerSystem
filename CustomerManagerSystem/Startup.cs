...
namespace CustomerManagerSystem
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ICompanyDal, EfCompanyDal>();
            services.AddAuthentication("PanelSecurityScheme")
               .AddCookie("PanelSecurityScheme", options =>
               {
                   options.Cookie = new CookieBuilder
                   {
                          //Domain = "",
                          HttpOnly = false,
                       Name = "Panel.Security.Cookie",
                       Path = "/",
